...
<header id="top" class="stm-header">
	<div class="stm-container">
		<div class="row">
			<div class="container">
				<div class="col span_3 stm-header-one">
					<?php 

					// how insert visual composer widget here?
					echo do_shortcode('[nectar_global_section id="7699"]');
		...
		<div class="row">
			<div class="col span_9 col_last stm-header-two">
					<?php
